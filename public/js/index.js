$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫张凡，在深圳从事WEB前端开发多年</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是解决网页前端展示，交互css特效</div>",2000);
	...
	w.load("<p><div class='writecode'>张凡</div>");
	w.load("<div class='writecode'>WEB前端工程师</div>");
	w.load("<div class='writecode'>前端/NodeJS 开发工程师</div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:brian.netmad@gmail.com</li>");
	w.load("<li class='writecode'>blog:<a href='http://netmad.me' target='_blank'>blog.youlunshidai.com</a></li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/brianzhang' target='_blank'>https://github.com/ccfromstar</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>精通Web前端开发技术，有过8年前端开发经验</li>");
	...
	w.load("<li class='writecode'>熟练与各开放平台接入开发（微信公众号，小程序，微博）</li>");
	w.load("<li class='writecode'>熟练Mysql,redis,mongodb和文档型数据库(domino)</li>");
	w.load("<li class='writecode'>熟练nginx,linux服务器部署和管理，及常见问题的处理</li>");
	w.load("<li class='writecode'>熟练svn,git等常用版本管理工具</li>");
	w.load("<li class='writecode'>熟悉办公自动化流程引擎的开发经验</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='http://www.kuaiwan.com' target='_blank'>www.kuaiwan.com</a></li>");
	w.load("<li class='writecode'><a href='http://www.qvod.com' target='_blank'>www.qvod.com</a></li>");
	w.load("<li class='writecode'><a href='http://fangyan.tv' target='_blank'>fangyan.tv</a></li>");
	w.load("<li class='writecode'><a href='http://teamcrushsport.com/' target='_blank'>teamcrushsport.com</a></li>");
	w.load("<li class='writecode'><a href='https://originsport.io/' target='_blank'>originsport</a></li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
